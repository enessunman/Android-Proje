...
public class HafizaOyunu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //card resimleri yükle
        cardsResource();

        // shuffle
        Collections.shuffle(Arrays.asList(cardsArray));

        //ikinci oyuncunun rengini değiştir.
    ...
    private  void doStuff(ImageView iv, int card){
        ...
        // hangi resim seçildiyse geçici sakla.
        if (cardNumber == 1){
    ...
    private void checkEnd(){
        ...
        if (iv_11.getVisibility() == View.INVISIBLE &&
                iv_12.getVisibility() == View.INVISIBLE && iv_13.getVisibility() == View.INVISIBLE &&
                iv_14.getVisibility() == View.INVISIBLE && iv_21.getVisibility() == View.INVISIBLE &&
                iv_22.getVisibility() == View.INVISIBLE && iv_23.getVisibility() == View.INVISIBLE &&
                iv_24.getVisibility() == View.INVISIBLE && iv_31.getVisibility() == View.INVISIBLE &&
                iv_32.getVisibility() == View.INVISIBLE && iv_34.getVisibility() == View.INVISIBLE  ) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(HafizaOyunu.this);
    ...
    private void cardsResource(){

        image101 = R.drawable.apple;
        image102 = R.drawable.cheese;
        image103 = R.drawable.grapes;
        image104 = R.drawable.orange;
        image105 = R.drawable.strawberry;
        image106 = R.drawable.water;

        image201 = R.drawable.apple2;
        image202 = R.drawable.cheese2;
        image203 = R.drawable.grapes2;
        image204 = R.drawable.orange2;
        image205 = R.drawable.strawberry2;
        image206 = R.drawable.water2;
    }
}
